...
class InputOptionsFragment: Fragment(R.layout.fragment_defined_manual) {
        ...
        Card(
            ...
            UISelectionTypeCard(
                ...
                navController.navigate(
                    R.id.action_inputOptionsFragment_to_playerDefinedFragmentWithScrollMiniplayerNone,
                    bundleOf(Constants.UI_TYPE to Constants.UI_TYPE_XML_DEFINED)
                )
            }
            UISelectionTypeCard(
                modifier = Modifier.padding(
                ...
                navController.navigate(
                    R.id.action_inputOptionsFragment_to_introductionFragment,
                )
            }
        }
    }
