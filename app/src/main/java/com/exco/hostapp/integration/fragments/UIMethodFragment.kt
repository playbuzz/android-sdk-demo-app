...
class UIMethodFragment: Fragment(R.layout.fragment_ui_method) {
    ...
    private fun SelectionCard(
        ...
        val configurations = arguments?.getBundle(Constants.CONFIG_BUNDLE_KEY)
        Card(
            modifier = modifier,
            shape = RoundedCornerShape(
                topStart = 32.dp,
            ...
            UISelectionTypeCard(
                ...
                "XML - ScrollView",
                "The screen will be created from xml layout using ScrollView."
            ) {
                navController.navigate(
                    R.id.action_uiMethodFragment_to_playerFragmentWithScroll,
                    configurations
                )
            }
            UISelectionTypeCard(
                ...
                "XML - RecyclerView",
                "The screen will be created from xml layout using RecyclerView."
            ) {
                navController.navigate(
                    R.id.action_uiMethodFragment_to_playerFragmentWithRecycler,
                    configurations
                )
            }
            UISelectionTypeCard(
                ...
                navController.navigate(
                    R.id.action_uiMethodFragment_to_composePlayerWithScroll,
                    configurations
                )
            }
        }
